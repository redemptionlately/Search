...
const files = ['schools.json', 'score_lines.sample.json', 'score_lines_verified.json', 'notices.sample.json', 'evaluations.sample.json', 'national_lines.json', 'regions.json', 'majors.json'];
